...
<>
  ...
  >
    <Container maxWidth="xl">
      <Stack spacing={3}>
        <div>
          <Typography variant="h4">Crea Operatore</Typography>
        </div>
          ...
          <Card sx={{ p: 3, width: "700px" }}>
              ...
              <div>
                ...
                <div>
                  <Typography color="text.secondary" variant="caption">
                    Dimensioni consigliate: 200x200, dimensione massima del file: 5MB
                  </Typography>
                </div>
              </div>
            </Stack>
            <form onSubmit={formik.handleSubmit}>
              <Stack direction="row" spacing={2} sx={{ mb: 3 }}>
                <div>
                  <Typography color="text.secondary" variant="caption">
                    Aggiungi il nome dell'account e la password per creare l'operatore
                  </Typography>
                </div>
              </Stack>
              <Box>
